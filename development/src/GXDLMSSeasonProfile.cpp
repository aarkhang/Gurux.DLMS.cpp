...
/**
 Constructor.
*/
CGXDLMSSeasonProfile::CGXDLMSSeasonProfile(std::string name, const CGXDateTime& start, std::string weekName)
{
...
/**
 Constructor.
*/
CGXDLMSSeasonProfile::CGXDLMSSeasonProfile(CGXByteBuffer& name, const CGXDateTime& start, CGXByteBuffer weekName)
{
    m_Name.Set(&name);
    SetStart(start);
